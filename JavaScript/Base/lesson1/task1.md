...
- Добавьте в него пары ключ: значения => _name_ = _"Your_name"_, _age_ = _Your_age(type number)_, _friends_ = _["Add list of friend's names into this array"]_, _soc_links_(тип объект) с 2 ключами: facebook and googlePlus
